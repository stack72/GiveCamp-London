...
using GiveCampStarterKit.Website.Areas.TeamAdministration.Controllers;
using Rhino.Mocks;
...
namespace GiveCampStarterKit.Tests.UnitTests.Controllers.Areas.TeamAdministration
{
    [TestFixture]
