...
using GiveCampStarterKit.Website.Areas.UserAdministration.Models.UserAdministration;
using GiveCampStarterKit.Website.Controllers;
using MvcMembership;
using MvcMembership.Settings;

namespace GiveCampStarterKit.Website.Areas.UserAdministration.Controllers
{
